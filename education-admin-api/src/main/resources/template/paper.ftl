...
<div class=3DWordSection1 style=3D'layout-grid:15.6pt'>
    ...
    <h1 align=3Dcenter style=3D'text-align:center'>${title}</h1>
    <div class=WordSection1 style='layout-grid:15.6pt'>
        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>考试科目：${subjectName}<span
                        lang=EN-US><o:p></o:p></span></span></p>

        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>时间：<span lang=EN-US>100</span>分钟<span
                        lang=EN-US><o:p></o:p></span></span></p>

        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>班级：<span lang=EN-US>_____________________________<o:p></o:p></span></span></p>

        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>学号：<span lang=EN-US>_____________________________<o:p></o:p></span></span></p>

        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>姓名：<span lang=EN-US>_____________________________<o:p></o:p></span></span></p>

        <p class=MsoNormal style='text-indent:94.5pt;mso-char-indent-count:7.0;
    mso-pagination:widow-orphan'><span style='font-size:13.5pt;font-family:"微软雅黑",sans-serif;
    mso-bidi-font-family:宋体;color:black;mso-font-kerning:0pt'>得分：<span lang=EN-US>_____________________________<o:p></o:p></span></span></p>
    ...
    宋体;color:black;mso-font-kerning:0pt'><o:p>&nbsp;</o:p></span></p>
        ...
        <#list dataList as item>
            <#if item.questionList??>
                <p class=MsoListParagraph style='margin-left:40.2pt;text-indent:-40.2pt;
    mso-char-indent-count:0;mso-list:l0 level1 lfo1'><![if !supportLists]><span
                            lang=EN-US style='font-size:16.0pt;mso-bidi-font-family:等线;mso-bidi-theme-font:
    minor-fareast'><span style='mso-list:Ignore'>一、<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;
    </span></span></span><![endif]><span style='font-size:16.0pt'>${item.questionTypeName}<span
                                lang=EN-US><o:p></o:p></span></span></p>
                <#list item.questionList as data>
                    <p class=MsoListParagraph style='margin-left:40.2pt;text-indent:0cm;mso-char-indent-count:
    0'><span lang=EN-US style='font-size:16.0pt'></span><span style='font-size:
    16.0pt'>
                        <span lang=EN-US></span>${data.questionContent}<span lang=EN-US><o:p></o:p></span></span></p>

                    <#if data.options??>
                        <#list data.options as option>
                            <p class=3DMsoNormal><span lang=3DEN-US style=3D'mso-bidi-font-size:12.5pt'=
                                ><span
                                            class=3DSpellE>${option.option}</span></span></p>
                        </#list>
                    </#if>
                </#list>
            </#if>

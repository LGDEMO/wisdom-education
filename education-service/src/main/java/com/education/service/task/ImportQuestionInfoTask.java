        ...
        try {
            if (isRunning) {
                ...
                for (QuestionInfo questionInfo : dataList) {
                    ...
                    params.put("question_type", questionTypes.get(type));
                    ...
                    if (ObjectUtils.isNotEmpty(primarySchool.get(gradeName))) {
                        params.put("grade_type", primarySchool.get(gradeName));
                        params.put("school_type", EnumConstants.SchoolType.PRIMARY_SCHOOL.getValue());
                    } else if (ObjectUtils.isNotEmpty(middleSchool.get(gradeName))) {
                        params.put("grade_type", middleSchool.get(gradeName));
                        params.put("school_type", EnumConstants.SchoolType.MIDDLE_SCHOOL.getValue());
                    } else {
                        params.put("grade_type", highSchool.get(gradeName));
                        params.put("school_type", EnumConstants.SchoolType.HIGH_SCHOOL.getValue());
                    }
